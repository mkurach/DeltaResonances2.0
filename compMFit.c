...
void compMFit() {
    ...
    TString fileNames[_N_CASES_]= {"outputBasic/outCaseA.root","outputBasic/outCaseB.root","outputBasic/outCaseC.root"};
    ...
    TFile* fileOut = new TFile("outputM/outFitM.root","RECREATE");
	fileOut->cd();
