...
void createBWSpectraDiffRange() { 
 //N*0(1440),N*0(1520),N*0(1535),Delta0(1600),Delta0(1620),N*0(1650),N*0(1675), N*0(1680),Ns2250zer,Ns2190zer,Ns1720zer,Ns1700zer,Dl2420zer,Dl1950zer,Dl1700zer
    ...
    for(int i = 0; i < _N_PARTICLES_; i++) {
        ...
        //cout<<mass<<endl;
        mMin[i] = massTresh[i];
        //mMin[i] = mass - 2.0*gamma;
        mMax[i] = mass + 12.0*gamma;
        ...
        //fun[i]->Draw();
        hist[i]->Draw();
        can[i]->SaveAs(Form("outputMassSpectra/%sConstGamma.png",particle[i]->GetName()));
